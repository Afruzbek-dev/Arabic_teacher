...
export const CURRICULUM = {
    ...
    units: [
      {
        ...
        lessons: [
          {
            id: 'B2-U1-L1',
            title: "Iqtisodiy atamalar va إِنَّ",
            type: 'standard',
            objectives: ['Iqtisodiy lug\'at', 'إِنَّ va uning singillari'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'reading', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v400', 'v401', 'v402', 'v403', 'v404', 'v405', 'v406'],
            grammarId: 'g-inna',
            readingId: 'p-economy',
            xp: 25,
          },
      ...
      {
        id: 'B2-U2',
        title: 'Ilm-fan va texnologiya',
        book: 'At-Takallum 3',
        lessons: [
          {
            id: 'B2-U2-L1',
            title: "Texnologiya va majhul nisbat",
            type: 'standard',
            objectives: ['Ilm-fan lug\'ati', 'Majhul (noma\'lum nisbat)'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'reading', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v410', 'v411', 'v412', 'v413', 'v414', 'v415'],
            grammarId: 'g-passive',
            readingId: 'p-science',
            xp: 25,
          },
      ...
      },
      {
        ...
        lessons: [
          {
            id: 'B2-U3-L1',
            title: "Adabiyot va sifatdosh gap",
            type: 'standard',
            objectives: ['Adabiy atamalar', 'الَّذِي / الَّتِي (sifatdosh gap)'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v420', 'v421', 'v422', 'v423', 'v424', 'v425'],
            grammarId: 'g-relative',
            readingId: null,
            xp: 25,
          },
        ],
      ...
      {
        id: 'B2-U4',
        title: 'Murakkab grammatika',
        book: 'At-Takallum 3',
        lessons: [
          {
            id: 'B2-U4-L1',
            title: "إِنَّ va majhul takrori",
            type: 'standard',
            objectives: ['إِنَّ va singillari chuqur', 'Majhul takror'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v400', 'v410', 'v413', 'v415', 'v430', 'v431'],
            grammarId: 'g-inna',
            readingId: null,
            xp: 25,
          },
      ...
      {
        id: 'B2-U5',
        title: 'Rasmiy muloqot',
        book: 'At-Takallum 3',
        lessons: [
          {
            id: 'B2-U5-L1',
            title: "Rasmiy til va diplomatiya",
            type: 'standard',
            objectives: ['Rasmiy muloqot lug\'ati', 'Sifatdosh gaplar amalda'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'reading', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v430', 'v431', 'v432', 'v433', 'v434'],
            grammarId: 'g-relative',
            readingId: 'p-economy',
            xp: 25,
          },
    ...
    units: [
      {
        ...
        lessons: [
          {
            id: 'C1-U1-L1',
            title: "Ilmiy uslub va nasb holat",
            type: 'standard',
            objectives: ['Akademik atamalar', 'Nasb holat (أَنْ / لَنْ / كَيْ)'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'reading', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v500', 'v501', 'v502', 'v503', 'v504', 'v505'],
            grammarId: 'g-subjunctive',
            readingId: 'p-academic',
            xp: 30,
          },
        ],
      },
      {
        ...
        lessons: [
          {
            id: 'C1-U2-L1',
            title: "Siyosat va shart gaplar",
            type: 'standard',
            objectives: ['Siyosiy lug\'at', 'Shart gaplar (إِنْ / لَوْ)'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'reading', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v510', 'v511', 'v512', 'v513', 'v514', 'v515'],
            grammarId: 'g-conditionals',
            readingId: 'p-politics',
            xp: 30,
          },
        ],
      },
      {
        id: 'C1-U3',
        title: 'Islomiy matnlar',
        book: 'At-Takallum 4',
        lessons: [
          {
            id: 'C1-U3-L1',
            title: "Islomiy atamalar va fe'l vaznlari",
            type: 'standard',
            objectives: ['Islomiy ilm terminlari', 'Ilg\'or fe\'l vaznlari'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v530', 'v531', 'v532', 'v533', 'v534'],
            grammarId: 'g-advanced-verb',
            readingId: null,
            xp: 30,
          },
        ],
      ...
      {
        id: 'C1-U4',
        title: 'Media va jurnalistika',
        book: 'At-Takallum 4',
        lessons: [
          {
            id: 'C1-U4-L1',
            title: "Media va xabar tahlili",
            type: 'standard',
            objectives: ['Jurnalistik lug\'at', 'Shart + nasb amalda'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v520', 'v521', 'v522', 'v523'],
            grammarId: 'g-conditionals',
            readingId: null,
            xp: 30,
          },
  ...
  C2: {
    ...
    units: [
      {
        id: 'C2-U1',
        title: 'Klassik arab adabiyoti',
        book: 'At-Takallum 5',
        lessons: [
          {
            id: 'C2-U1-L1',
            title: "Klassik she'riyat va balog'a",
            type: 'standard',
            objectives: ['Klassik adabiyot', 'Ritorik san\'atlar (tashbih, isti\'ora)'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'reading', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v600', 'v601', 'v602', 'v603', 'v604', 'v605', 'v606'],
            grammarId: 'g-rhetoric',
            readingId: 'p-classical',
            xp: 35,
          },
        ],
      },
      {
        id: 'C2-U2',
        title: 'Ilmiy tadqiqot yozish',
        book: 'At-Takallum 5',
        lessons: [
          {
            id: 'C2-U2-L1',
            title: "Ilmiy maqola va i'rob tahlili",
            type: 'standard',
            objectives: ['Ilmiy yozuv terminlari', 'Murakkab i\'rob'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v610', 'v611', 'v612', 'v613', 'v614'],
            grammarId: 'g-irab',
            readingId: null,
            xp: 35,
          },
      ...
      {
        id: 'C2-U3',
        title: 'Dialektlar va fusha',
        book: 'At-Takallum 5',
        lessons: [
          {
            id: 'C2-U3-L1',
            title: "Lahja va fusha farqi",
            type: 'standard',
            objectives: ['Dialekt / fusha terminlari', 'Balog\'a takrori'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v620', 'v621', 'v622', 'v623', 'v624'],
            grammarId: 'g-rhetoric',
            readingId: null,
            xp: 35,
          },
      ...
      {
        id: 'C2-U4',
        title: 'Tarjima va interpretatsiya',
        book: 'At-Takallum 5',
        lessons: [
          {
            id: 'C2-U4-L1',
            title: "Tarjima nazariyasi va amaliyoti",
            type: 'standard',
            objectives: ['Tarjima terminlari', 'I\'rob amalda'],
            skills: ['vocab', 'recognition', 'listening', 'grammar', 'reading', 'speaking', 'writing', 'quiz'],
            vocabIds: ['v630', 'v631', 'v632', 'v633'],
            grammarId: 'g-irab',
            readingId: 'p-translation',
            xp: 35,
          },
        ],
      },
